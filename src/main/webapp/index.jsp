...
<p class="w-100 text-center my-5">Добро пожаловать в "FurnitureShop | магазин мягкой мебели"!</p>
                ...
                <c:forEach var="product" items="${listProducts}">
                    <li class="ant-carousel-element">
                        <div class="card m-2">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" style="white-space: nowrap; text-overflow: ellipsis; overflow: hidden; line-height: 2rem">${product.title} ${product.model}</h5>
